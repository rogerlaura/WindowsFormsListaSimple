            ...
            else
            {
                ...
                else
                {
                    if (cursor == primero)
                    {
                       ...
                       // primero = primero.pEnlace; //FUNCIONA SIEMPRE Y CUANDO EL CURSOR ESTE EN PRIMERO NODO

                    }

                    primero = primero.pEnlace; //SACAR DE LA CONDICION   -> FUNCIONA EN TODOS LOS CASOS
